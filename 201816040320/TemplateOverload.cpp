...
int main()
{
   ...
   elements = printArray(a,0,4);/* Write a call to printArray that specifies
   ...
   elements = printArray( b, 0, 6 );/* Write a call to printArray that specifies
   ...
   elements = printArray( c, 0, 4 );/* Write a call to printArray that specifies
